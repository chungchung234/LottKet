...
<%
    List<ProductDto> list = (List<ProductDto>)request.getAttribute("insertProduct");
...
<div class="contents-list">
    <form action="insertProduct.do">
        <div class="insert-content">
            ...
            제품가격 : <input type="text" name="productCategory"><br>
            가격 : <input type="text" name="productPrice"><br>
            재고 : <input type="text" name="productStock"><br>
            <div id="plus-image">
                <button type="button" onclick="plusImage()" value="추가"></button>
        ...
        <ul>
            ...
            <li>
                <div class="product">
                    ...
                    제품가격 : <input type="text" id="productCategory<%=i%>" ame="productCategory" value="<%=productDto.getProductPrice()%>"><br>
